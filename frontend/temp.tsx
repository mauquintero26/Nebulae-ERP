...
import { 
  MessageCircle, Camera, Globe, LayoutGrid, 
  Search, MoreVertical, Send, Paperclip, CheckCheck,
  Bot, Sparkles, Receipt, FileText, ChevronRight, User, ExternalLink, X, ShoppingCart, Calculator, ArrowRight
} from 'lucide-react';
...
export default function CRMPage() {
  ...
  const [crmWidth, setCrmWidth] = useState(380);
  ...
  return (
    <div className="h-full w-full bg-white flex overflow-hidden">
      ...
      <div 
        ...
        style={{ width: inboxWidth, resize: 'horizontal', minWidth: '250px', maxWidth: '500px' }}
      >
        ...
        {/* Simple Resize Handle (Visual Only for mock) */}
        <div className="absolute right-0 top-0 bottom-0 w-1 hover:bg-purple-200 cursor-col-resize" />
      </div>
      ...
      <div className="flex-1 flex flex-col bg-slate-50/50 relative min-w-[300px]">
        ...
        <div className="p-4 bg-white border-t border-slate-200">
          <div className="flex items-end gap-2 bg-slate-50 border border-slate-200 p-2 rounded-2xl focus-within:border-purple-400 focus-within:ring-2 focus-within:ring-purple-100 transition-all">
            ...
            />
            <button className="p-3 bg-purple-600 text-white rounded-xl shadow-md hover:bg-purple-700 transition-colors">
      ...
      >
          ...
          <div className="space-y-3">
            <div className="bg-amber-50 border border-amber-100 p-4 rounded-2xl">
              ...
              <p className="text-sm text-amber-900/80 leading-relaxed">
                Interesada en el extractor manual. Validar si requiere envío a Medellín.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* BOTTOM: NEBULAE IA */}
        <div className="h-[55%] flex flex-col bg-gradient-to-b from-slate-50 to-indigo-50/50">
          <div className="p-4 border-b border-indigo-100/50 bg-white/60 backdrop-blur-md flex justify-between items-center">
            <div className="flex items-center gap-2">
              <div className="bg-indigo-600 p-1.5 rounded-lg shadow-md shadow-indigo-200">
                <Sparkles className="text-white" size={14} />
              </div>
              <h3 className="font-extrabold text-indigo-900 text-sm">Nebulae IA</h3>
            </div>
            ...
            <label className="flex items-center cursor-pointer">
              ...
              <span className="ml-2 text-[10px] font-bold text-slate-500 uppercase">Auto</span>
            </label>
          </div>
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-white p-3 rounded-xl border border-indigo-50 shadow-sm">
                <p className="text-[10px] font-bold text-slate-400 uppercase">LTV (Total)</p>
                <p className="text-sm font-extrabold text-slate-700">$1,450.000</p>
              </div>
              <div 
                className="bg-white p-3 rounded-xl border border-indigo-50 shadow-sm cursor-pointer hover:border-indigo-300 hover:shadow-md transition-all group"
                onClick={() => setShowPurchasesModal(true)}
              >
                <div className="flex justify-between items-center">
                  <p className="text-[10px] font-bold text-slate-400 uppercase group-hover:text-indigo-500 transition-colors">Últimas Compras</p>
                  <ExternalLink size={10} className="text-slate-300 group-hover:text-indigo-400" />
                </div>
                <p className="text-sm font-extrabold text-slate-700">Ver historial (3)</p>
              </div>
              <div className="bg-white p-3 rounded-xl border border-indigo-50 shadow-sm col-span-2">
                ...
                <p className="text-sm font-medium text-slate-600">Cliente Recurrente • Historial de 4 compras.</p>
              </div>
            </div>
            ...
            <div className="bg-indigo-600 p-4 rounded-2xl shadow-md text-white">
              <div className="flex justify-between items-start mb-2">
                <p className="text-xs font-bold text-indigo-200 uppercase tracking-wider flex items-center gap-1">
                  <Bot size={12} /> IA Sugiere:
                </p>
                <span className="text-[9px] bg-indigo-500 px-1.5 py-0.5 rounded font-medium">Pipeline: Cotización</span>
              </div>
          ...
          <div className="p-3 bg-white border-t border-indigo-100/50">
             <div className="bg-slate-50 border border-slate-200 rounded-xl flex items-center p-1.5 focus-within:border-indigo-400 focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
                <input 
                  type="text" 
                  placeholder="Pregunta o instruye a Nebulae IA..."
                  className="flex-1 bg-transparent border-none text-xs px-2 py-1 outline-none text-slate-700"
                />
                <button className="bg-indigo-600 p-2 rounded-lg text-white hover:bg-indigo-700 transition-colors shadow-sm">
                  <Bot size={16} />
                </button>
             </div>
          </div>
