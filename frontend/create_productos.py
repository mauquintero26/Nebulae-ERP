...
os.makedirs('src/app/dashboard/inventario/productos', exist_ok=True)
...
with open('src/app/dashboard/inventario/productos/page.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
print("Productos page created successfully")
