...
// â”€â”€ ActionIcon for activity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Calculator Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-gradient-to-r from-amber-50 to-white">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">{cot.numero} â€” {cot.customer_name}</p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <label className="text-xs font-black text-slate-500 uppercase mb-1 block">TRM (USDâ†’COP)</label>
...
// â”€â”€ Delete Confirm Dialog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-sm w-full mx-4">
        ...
        <p className="text-slate-500 text-center text-sm mb-2">
          Â¿Estas seguro de eliminar <strong>{cot.numero}</strong>?
        </p>
      ...
      {(sinCalc > 0 || vencenPronto > 0 || sinAtender > 0) && (
        <div className="bg-amber-50 border-b border-amber-200 px-6 py-3 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="text-sm font-black text-amber-800">ATENCION â€” Cotizaciones requieren accion (Alerta {alertDias} dias)</h4>
      ...
      <div className="p-8 max-w-[1600px] mx-auto space-y-8">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-slate-500 mt-2 font-medium">COT-YYYY#### â€” Genera precios, envia al cliente y confirma para crear Pedido de Venta.</p>
          </div>
          <div className="flex gap-3">
                    ...
                    {Object.entries(ESTADOS)
                      ...
                      .map(([k, v]) => (
                        <button key={k} onClick={() => {
                          if (k === 'RECHAZADA' && !window.confirm(`Â¿Marcar como Rechazada? La SC vinculada permanecera activa.`)) return;
                          changeEstado(k);
                        }}
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          ...
                          <button onClick={()=>{
                            ...
                            {Number(selected.total_cop)>0?'Re-Cotizar â€” Actualizar Precios':'Cotiza â€” Calcular Precios'}
                          </button>
                            ...
                            <div key={a.id} className="flex gap-4 pl-7 relative">
                              ...
                              <div className="flex-1 bg-white border border-slate-100 rounded-xl p-3 shadow-sm">
                                ...
                                <p className="text-xs text-slate-400 mt-1">
                                  ...
                                  {a.user_name && <span className="ml-2 font-medium">â€¢ {a.user_name}</span>}
                                </p>
                              </div>
                            </div>
                          ))}
