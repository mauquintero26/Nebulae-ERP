...
export default function CompartidoHub() {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight flex items-center gap-2">
            <Users2 className="text-emerald-600" size={28} /> Inventario Compartido
          </h1>
          <p className="text-slate-500 mt-1 font-medium">Gestión colaborativa de stock. Esperando especificaciones...</p>
        </div>
      </div>
            ...
            <table className="w-full text-left table-fixed">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-xs text-slate-500 uppercase tracking-wider sticky top-0 z-10">
                  <ResizableHeader>ID Recurso</ResizableHeader>
                  <ResizableHeader>Entidad</ResizableHeader>
                  <ResizableHeader>Stock Compartido</ResizableHeader>
                  <ResizableHeader>Condiciones</ResizableHeader>
