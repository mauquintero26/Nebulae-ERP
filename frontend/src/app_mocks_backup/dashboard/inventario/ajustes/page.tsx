      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight flex items-center gap-2">
            <Settings2 className="text-emerald-600" size={28} /> Ajustes de Inventario
          </h1>
          <p className="text-slate-500 mt-1 font-medium">Regularización de stock por mermas, daños, faltantes o sobrantes.</p>
        </div>
      </div>
            ...
            <table className="w-full text-left table-fixed">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-xs text-slate-500 uppercase tracking-wider sticky top-0 z-10">
                  <ResizableHeader>ID Ajuste</ResizableHeader>
                  <ResizableHeader>Motivo</ResizableHeader>
                  <ResizableHeader>Bodega</ResizableHeader>
                  <ResizableHeader>Costo Afectado</ResizableHeader>
                  <ResizableHeader>Aprobación</ResizableHeader>
                </tr>
              </thead>
