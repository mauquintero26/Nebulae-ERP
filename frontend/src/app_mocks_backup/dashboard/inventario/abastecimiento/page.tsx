...
export default function AbastecimientoHub() {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight flex items-center gap-2">
            <ShoppingCart className="text-emerald-600" size={28} /> Abastecimiento
          </h1>
          <p className="text-slate-500 mt-1 font-medium">Sugerencias de compra y reposición basadas en puntos de reorden y alertas.</p>
        </div>
      </div>
            ...
            <table className="w-full text-left table-fixed">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-xs text-slate-500 uppercase tracking-wider sticky top-0 z-10">
                  <ResizableHeader>SKU</ResizableHeader>
                  <ResizableHeader>Producto</ResizableHeader>
                  <ResizableHeader>Stock Actual</ResizableHeader>
                  <ResizableHeader>Punto Reorden</ResizableHeader>
                  <ResizableHeader>Sugerencia Compra</ResizableHeader>
                </tr>
              </thead>
