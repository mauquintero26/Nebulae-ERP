    ...
    <div className="h-full w-full bg-[#1e1e24] flex flex-col overflow-hidden text-slate-300 font-sans animate-in fade-in">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 bg-[#0f0f11] p-8 flex items-center justify-center overflow-y-auto custom-scrollbar relative">
          ...
          <div 
            className={`bg-white rounded-xl shadow-2xl transition-all duration-500 overflow-hidden relative flex flex-col ${
              device === 'desktop' ? 'w-full max-w-5xl h-[800px]' : 
              device === 'tablet' ? 'w-[768px] h-[1024px]' : 'w-[375px] h-[812px]'
            }`}
          >
            {/* Título y URL mockeada de la ventana */}
            <div className="bg-slate-100 h-8 flex items-center px-4 gap-2 border-b border-slate-200 flex-shrink-0">
            ...
            <div className="w-full flex-1 overflow-y-auto bg-white text-slate-800 custom-scrollbar">
            ...
            <div className="absolute top-1/4 left-1/4 right-1/4 h-64 border-2 border-dashed border-purple-500 bg-purple-500/10 pointer-events-none rounded-2xl flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity z-10">
