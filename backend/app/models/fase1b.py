...
class SaleOrderLineErp(Base):
    ...
    modalidad          = Column(String(30), nullable=False, default="POR_PEDIDO")
    ...
    quantity_delivered = Column(Numeric(10, 2), nullable=False, default=0)
    quantity_cancelled = Column(Numeric(10, 2), nullable=False, default=0)
    estado             = Column(String(50), nullable=False, default="PENDIENTE")
    # PENDIENTE | PENDIENTE_COMPRA | PENDIENTE_RESERVA | ASIGNADA_COMPRA | PARCIALMENTE_DISPONIBLE | RESERVADA | LISTA_PARA_ENTREGA | ENTREGADA | CANCELADA | DEVUELTA_PARCIAL | DEVUELTA_TOTAL
    cost_unit_cop_snapshot  = Column(Numeric(14, 2), nullable=False, default=0)
    price_unit_cop_snapshot = Column(Numeric(14, 2), nullable=False, default=0)
    source             = Column(String(20), nullable=False, default="NATIVE")
    migration_batch_id = Column(String(50), nullable=True, index=True)
    created_at         = Column(DateTime, default=_now)
