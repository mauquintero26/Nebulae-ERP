...
from app.api.v1 import erp_ventas, erp_compras, ecommerce, erp_logistica
...
app.include_router(erp_logistica.router, prefix="/api/v1/compras", tags=["ERP Logística y Tránsito"])
